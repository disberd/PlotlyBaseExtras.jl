...
md"""
The function returns a `ColorScheme` object, which can be directly used in PlotlyBaseExtras as input to the `colorscale` property of `heatmap` and other traces/layouts.
"""
...
md"""
For this reason, PlotlyBaseExtras provides another convenience function which simplify the creation of discrete colorscales.
