...
# ╔═╡ 478603e0-17f0-466e-a0be-34405390f7e8
using PlutoDevMacros

# ╔═╡ 08b57cb3-6a15-475a-863d-aed7542679fe
# This notebook lives in test/fixtures, one level deeper than notebooks/, so
# the package root sits two levels up.
@frompackage raw"../.." begin
	using ^
	using >.LaTeXStrings
end
