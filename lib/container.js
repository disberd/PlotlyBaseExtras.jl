...
// `renderPlot` is the ONE entry point an Adapter (pluto_adapter.js, and later
// the plain-HTML / VSCode ones) calls; `makeContainer` and `updatePlotData`
// below are internal to this file.
